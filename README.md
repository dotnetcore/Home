...
- **[EntityFrameworkCore.GaussDB](https://github.com/dotnetcore/EntityFrameworkCore.GaussDB)**, an Entity Framework Core provider for GaussDB.
- **[EntityFrameworkCore.KingbaseES](https://github.com/dotnetcore/EntityFrameworkCore.KingbaseES)**, an Entity Framework Core provider for KingbaseES.
